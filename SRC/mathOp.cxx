...
void mathOp::getVectors(vector<int> a, vector<int>b) {
	input_1 = a;
	input_2 = b;
}

double mathOp::calcMu(vector<int> input)
{
	double sum = 0;
...
double mathOp::calcCorro(vector<int> _input_1, vector<int> _input_2)
{
	input_1 = _input_1;
	input_2 = _input_2;
	Mu_1 = calcMu(input_1);
...
double mathOp::calcVari(vector<int> input)
{
...
double mathOp::calcVari(vector<int> input, double mu)
{
	double vari = 0;
	for (size_t i = 0; i < input.size(); i++) {
